...
const CreateTest = () => {
  ...
  const callCreateTestAPI = async () => {
    ...
    mutate(`/api/tests?page=1&offset=0&limit=50&isbuddie=true&`);
                              ...
                              form.setFields([
                                {
                                  ...
                                  errors: [
                                    'Thời gian làm bài của các phần không được vượt quá thời gian làm bài của bài thi.',
                                  ],
                                },
                              ]);
                            } else {
                                        ...
                                        form.setFields([
                                          {
                                            ...
                                            errors: [
                                              'Thời gian làm bài của các nhóm câu hỏi không được vượt quá thời gian làm bài của phần thi.',
                                            ],
                                          },
                                        ]);
                                      } else {
                                                    ...
                                                    form.setFields([
                                                      {
                                                        ...
                                                        errors: [
                                                          'Thời gian làm bài của các câu hỏi không được vượt quá thời gian làm bài của nhóm câu hỏi.',
                                                        ],
                                                      },
                                                    ]);
                                                  } else {
