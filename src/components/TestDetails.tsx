...
export default function TestDetails({ user_name, rating, rating_count, update_date, submission_count }: { user_name: string; rating: number; rating_count: number; update_date: string; submission_count: number; }) {
    return (
